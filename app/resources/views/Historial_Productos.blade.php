        ...
        <div class="container">
          <div class="row bar">
            <div id="customer-order" class="col-lg-9">
              ...
              <p class="lead">Historial de Productos que fueron comprados y los que estan en procesos a ser preparados.</p>
              <div class="box">
                    ...
                    @foreach($pedidos as $pedido)
                      <tr>
                        ...
                        @if($pedido -> status=='Pagado')
                          <td><span class="badge badge-primary">{{$pedido -> status}}</span></td>
                        @elseif($pedido -> status=='Pendiente de pago')
              ...
              <div class="panel panel-default sidebar-menu">
                ...
                <div class="panel-body">
                  <ul class="nav nav-pills flex-column text-sm">
                    <li class="nav-item"><a href="{{route('his')}}" class="nav-link active"><i class="fa fa-list"></i> Mis ordenes</a></li>
                    <li class="nav-item"><a href="{{route('Config')}}" class="nav-link"><i class="fa fa-user"></i>Cambiar Contraseña</a></li>
                  </ul>
                </div>
              </div>
            </div>
