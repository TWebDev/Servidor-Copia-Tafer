  ...
  <body>
          ...
          <div class="input-group">
            ...
            <div id="heading-breadcrumbs">
              <div class="container">
                <div class="row d-flex align-items-center flex-wrap">
                  <div class="col-md-9">
                    <h1 class="h2">Confirmación de Pago - Pago por PayPal</h1>
                  </div>
                </div>
              </div>
            </div>
            <div class="jumbotron text-center">
              ...
              <p class="my-4">Estas a punto de pagar:
                ...
                <!--PayPal-->
              <script src="https://www.paypal.com/sdk/js?client-id=AW31njWm3AH-2ZnBpKHXu18h7MEeoe_J9SfnqEaOxMZuwKyNFdscRdPbKi45e6jwcTMWmUaEwEefsiJl&currency=MXN">
              </script>
    ...
    <script>
      ...
      return actions.order.capture().then(function(details) {
        ...
        window.location.href="{{route('PasoFinal')}}";
      });
    }
