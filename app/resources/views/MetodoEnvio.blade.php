      ...
      <div id="heading-breadcrumbs">
        <div class="container">
          <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-9">
              <h1 class="h2">Confirmación de Pedido - Método de Envío</h1>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="container">
          <div class="row">
            <div id="checkout" class="col-lg-12">
              <div class="box">
                <form method="get"  action="{{route('Domicilio')}}">
                @csrf
                <input type="hidden" name="metodopago" value={{$metodopago}}>
                  <ul class="nav nav-pills nav-fill">
                    ...
                    <li class="nav-item"><a href="shop-checkout2.html" class="nav-link active"><i class="fa fa-truck"></i><br>Modo de Entrega</a></li>
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="box shipping-method">
                          ...
                          <p><img src="{{ asset('img/RegaloEntrega1.png') }}" alt="Envio Domicilio" class="img-fluid" style="width: 180px; height: 100px;"></p>
                        </center>
                          <div class="box-footer text-center">
                            <input type="radio" name="delivery" value="Domicilio">
                          </div>
                        </div>
                      </div>
                      <div class="col-sm-6">
                        <div class="box shipping-method">
                          <center><h4>Recoger en Sucursal</h4>
                          <p><img src="{{ asset('img/RegaloEntrega2.png') }}" alt="Recoger en Sucursal" class="img-fluid" style="width: 150px; height: 100px;"></p>
                        </center>
                          <div class="box-footer text-center">
                            <input type="radio" name="delivery" value="Tienda">
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="box-footer d-flex flex-wrap align-items-center justify-content-between">
                    <div class="left-col"><a href="{{ route('MetodoPago') }}" class="btn btn-secondary mt-0"><i class="fa fa-chevron-left"></i>Regresar</a></div>
                    <div class="right-col">
