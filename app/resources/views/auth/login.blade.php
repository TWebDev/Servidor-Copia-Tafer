      ...
      <div id="navbar" role="navigation" class="navbar navbar-expand-lg">
        <div class="container"><a href="{{route('home')}}" class="navbar-brand home"><img src="img/Regaloslogoch.jpg" alt="Male Globos y Regalos" class="d-none d-md-inline-block"><img src="" alt="Male Globos y Regalos" class="d-inline-block d-md-none"><span class="sr-only">Inicio</span></a>
          ...
          <div id="navigation" class="navbar-collapse collapse">
            ...
            <li  class="nav-item active"><a href="{{ route('login') }}">{{ __('Iniciar Sesion') }}</a></li>
    ...
    <div class="container" style="padding-bottom: 20px">
      <div class="row justify-content-center">
        <div class="col-md-8">
          <div class="card">
            <div class="card-body">
            <img style="width: 500px;padding-left: 200px;padding-bottom: 15px" src="{{asset('img/login.png')}}" style="width: 600px; padding-bottom: 20px; padding-left: 100px;color: pink;">
