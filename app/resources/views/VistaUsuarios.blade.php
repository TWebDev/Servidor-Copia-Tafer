  ...
  <body>
    <div id="all">
      <div class="admin-bar">
        ...
        <a href="{{route('usuarios')}}" class="icon icon-users" id="icon2"></a>
      </div>
    ...
    <header class="nav-holder make-sticky">
      ...
      <div id="content">
        <div class="container">
          <div class="row bar" style="padding-bottom: 169px">
            <div id="basket" class="col-lg-12">
              <div class="box mt-0 pb-0 no-horizontal-padding">
                <div class="row">
                  <div class="col-9"></div>
                  <div class="col-3">
                    <a href="{{ route('register') }}"> <i class="fa fa-plus">Agregar Usuario</i></a>
                  </div>
                ...
                <div class="table-responsive">
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td><a href="{{route('usuarios',$item ->id)}}">{{$item -> id}}</a></td>
                        <td>{{$item->nombre}}</td>
                        <td>{{$item -> email}}</td>
                        <td>{{$item -> telefono}}</td>
                      </tr>
                ...
                <div id="paginador">
                  {!! $User->links(); !!}
                  <!--Agregar el paginador para cambiar de lista con los usuarios-->
                </div>
              </div>
            </div>
          </div>
...
<script type="text/javascript">
      ...
      function drawStuff() {
        var data = new google.visualization.arrayToDataTable([
          ['Move', 'Dinero Total Invertido '],
            @foreach ($RUser as $tablas)
              ['{{ $tablas->nombre}}', {{ $tablas->TotalUsu}}],
            @endforeach
        ]);
        ...
        var options = {
          ...
          chart: {
            title: 'Usuarios con mayores Compras',
            subtitle: '' },
          axes: {
            x: {
