...
<!-- Empieza Footer -->
    ...
    <footer class="main-footer">
      <div class="container">
        <div class="row">
          <div class="col-lg-3">
            <h4 class="h6">Male globos y regalos</h4>
          ...
          <div class="col-lg-3">
            ...
            <p class="text-uppercase">Rafael Sanzio<br>505 local 2<br>Zapopan<br>GUADALAJARA,JAL.<br><strong>Angelica Vanessa Ascencio Juarez <br>TEL: 33 2301 5264</strong></p>
