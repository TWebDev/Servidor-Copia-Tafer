...
Route::get('/ConfigCuenta', function () {
    return view('ConfigCon');
})->name('Config');

Route::post('/ConfigCuenta/Exitoc', [
    'uses' => 'Usuario@Cambiarcon'
])->name('contra');

Route::post('/ConfigCuenta/Exitod', [
    'uses' => 'Usuario@cambiardat'
])->name('datos');

Route::get('/Historial', [
    'uses' => 'Usuario@historial'
])->name('his');
...
Route::get('Admin/ventas/{id}/pago',[
    'uses' => 'Admin@actpago'
])->name('actpago');

Route::get('Admin/ventas/{id}/entrega',[
    'uses' => 'Admin@entrega'
])->name('entrega');
